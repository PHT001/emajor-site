...
const univers = [
  {
    ...
    title: "Particuliers",
    description:
      "Appartements, maisons, hôtels particuliers. Rénovation, mise aux normes, dépannage urgent.",
    href: "/particuliers",
  ...
  },
  {
    ...
    description:
      "Bureaux, hôtels, restaurants, boutiques, théâtres. Pilotage de chantier, CVC, maintenance.",
    href: "/professionnels",
              ...
              <div className="absolute inset-0 p-8 sm:p-10 flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  ...
                  <span className="w-12 h-12 rounded-full bg-paper/10 backdrop-blur-sm border border-paper/20 flex items-center justify-center group-hover:bg-accent group-hover:border-accent transition-colors">
                    <ArrowUpRight
                      size={20}
                      className="text-paper group-hover:text-ink transition-colors"
                      strokeWidth={2.5}
                    />
                  </span>
                </div>
